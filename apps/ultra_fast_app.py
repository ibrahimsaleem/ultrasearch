#!/usr/bin/env python3
"""
Ultra Fast App - Minimal for Maximum Speed
"""
...
def main():
    st.set_page_config(
        page_title="⚡ Ultra Fast",
        page_icon="⚡",
        layout="wide"
    )
    
    st.title("⚡ Ultra Fast Search")
    st.markdown("**Minimal interface for maximum speed**")
    ...
    with st.sidebar:
        ...
        max_files = st.slider("Max files:", 50, 1000, 200)
    ...
    with col1:
        ...
        query = st.text_input(
            ...
            placeholder="e.g., PASSCODE variable...",
            key="search_query"
        )
    ...
    with col2:
        ...
        **Expected Times:**
        ...
        • Medium folders: 1-5 seconds
        • Large folders: 5-15 seconds
        """)
    
    # Footer
    st.markdown("---")
    st.markdown("**⚡ Ultra Fast** - Minimal for maximum speed")
